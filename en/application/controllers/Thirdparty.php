...
class Thirdparty extends REST_Controller {
    ...
    function gpicker_post(){
	   ...
	   $this->load->view('includes/folder', array("files"=>$data['ff'],"fpath"=>$data['fdetails'],"param"=>$data,"status"=>"success","folid"=>$folder_id));
