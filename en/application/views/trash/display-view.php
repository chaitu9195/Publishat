	...
	<div class="right-icons col-md-offset-0 col-md-3 col-xs-4 " id="right_icons" ">
	   ...
	   <a href="#/page=school?mode=edit" onclick="getedit('<?=$data[0]["RecordId"];?>','1','academics')"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a>
	...
	<div class="right-icons col-xs-offset-0 col-xs-2 col-md-1 col-md-offset-0 pull-left " id="right_icons" style="display:block;">
	 <button class="btn btn-primary" href="#/school" title ="Add new record" onclick="getVal('School','1','academics')"> back </button>
         </div>
       </div>
         ...
         $.ajax({
            ...
            success: function(data){  
             ...
             $('#error').show(); 
               ...
               $('#error').show(); 
               $('.content').hide(); 
               setTimeout(function(){  getVal('School','1','academics'); },4000);
             }
            }
        });
}
    ...
    if( emaillist == ''){
       ...
       var data = new FormData(this);
        $.ajax({
         ...
         //  setTimeout(function(){  getVal('School','1','academics'); },1000);
            }
