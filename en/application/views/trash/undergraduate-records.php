	<div class="row">
	 <div class="left-heading col-md-6">
		<span class="hidden-xs pull-left">
			...
			<span class="h3">UG / Graduate Records</span>
		</span>
		<span class="visible-xs pull-left">
		     <i class="fa fa-graduation-cap fa-2x" aria-hidden="true"></i>
	   		 <span class="h4">UG / Graduate Records</span>
	    </span>
	</div>
	<div class="right-icons col-md-offset-1 pull-right" id="right_icons" style="display:block;">
	   <button class="btn btn-primary" href="#/newschool" title ="Add new record" onclick="getNew('2','academic')"> Add <i class="fa fa-plus-square" aria-hidden="true"></i> </button>
	...
	<div class="right-icons col-md-offset-2 col-md-4 pull-right" id="right_icons" style="display:none;">
	 ...
	 <table class="table table-responsive table-striped table-hover">
	     <thead>
                  ...
                  <th> Document Type</th>
                  <th> File(s)</th>
                  <th class="hidden-xs">Created / Modified</th>
                  <th  class='col-sm-1 hidden-xs'></th>
	     </thead>
	     <tbody>
                 <?php  for($i=0;$i<=count($data ?? array())-1;$i++){ ?>
                <tr onclick='displayView(<?=$data[$i]["RecordId"];?>)' id='<?=$data[$i]["RecordId"];?>'>
                 <td><?=$data[$i]['Degree'];?></td>
                 <td><?=$data[$i]['AcademicYear'];?> / <?=$data[$i]['Term'];?> </td>
