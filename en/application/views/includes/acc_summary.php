...
<span class="fa fa-camera" id="photo">UpdateProfilePicture</span>
  ...
  <div class="col-md-6 col-md-offset-1 col-xs-12">
    ...
    <table class="table table-responsive" >
        ...
        <tr>
         	<td colspan="2"><h3>Health Info</h3></td>
        </tr> 
        <tr>
        	<td><b>Weight</b></td>
           ...
           <div class="col-md-4">
  	      ...
  	      <select name="state" name="state" class="form-control">
                         <option value="">Select</option>
                          <option value="Other" <?= ($state == "Other") ? "selected='selected'": "" ?>>Other Country / State</option>
			 <option value="Andaman And Nicobar Islands" <?= ($state == "Andaman And Nicobar Islands") ? "selected='selected'": "" ?>>Andaman And Nicobar Islands</option>
                          ...
                          <option value="Tamilnadu" <?= ($state == "Tamilnadu") ? "selected='selected'": "" ?>>Tamilnadu</option>
                          <option value="Telangana" <?= ($state == "Telangana") ? "selected='selected'": "" ?>>Telangana</option>                          
...
<script>
 ...
 $(document).ready(function () {   
  ...
  $('#dob').datetimepicker({ format: 'YYYY-MM-DD'  }); 
   $('#dob').click(function () { 
      $('#dob').datetimepicker({ format: 'YYYY-MM-DD',minDate:moment()  });
  });
