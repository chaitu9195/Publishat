...
<nav class="mainmenu-area" data-spy="affix" data-offset-top="200" style="background: #66b3ea;">
            ...
            <div class="navbar-header">
                ...
                <a href="<?php echo base_url(); ?>" class="navbar-brand"><h2>NTOTALWORLD</h2></a>
            ...
            <div class="collapse navbar-collapse" id="primary_menu">
                <ul class="nav navbar-nav mainmenu">
                    ...
                    <li><a href="<?php echo base_url(); ?>#features_page">About</a></li>
                    <li><a href="<?php echo base_url(); ?>#gallery_page">Gallery</a></li>
					<li><a href="<?php echo base_url(); ?>#download_page">Products</a></li>
					<li><a href="<?php echo base_url(); ?>#price_page">Pricing</a></li>
                    <li><a href="<?php echo base_url(); ?>#blogs_page">Blog</a></li>
                    <li><a href="<?php echo base_url(); ?>#contact_page">Contact</a></li>
                </ul>
            </div>
    </nav>