...
<nav class="navbar navbar-default">
    <div class="container mfull">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand " href="<?php echo base_url(); ?>"> <span class="h1 active"> Publishat</span> <!-- <img src="https://www.publishat.com/img/logo.png" class="img-responsive xs-hidden sm-hidden "/> --> </a>
        </div>
        <!-- 
