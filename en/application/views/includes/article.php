...
.head{width:65% !important;}
.write_article{border:1px solid rgb(152, 160, 175);padding:12px;border-radius: 20px;color:#337ab7}
.article{text-decoration:none;padding: 10px;}
.image{width: 30%;position:absolute;padding: 6px;margin: 3px;opacity: 0;}
.img_ico{border: 1px solid rgb(152, 160, 175);width: 32%;padding: 11px;border-radius: 20px;position:absolute;color:#337ab7;}
.post_article{border-radius: 10px;background-color:#0084bf;border:none;color:white;width: 16%;padding: 6px;}
.text_content{width:100%;height:85% !important;resize: none;padding: 20px;}
.content_div{height:384px;}
.share_article{font-size:20px;border-bottom:1px solid rgb(222, 224, 230);}
.Editor-container{width:97% !important;}
.desc img{width:60% !important;}
</style>
</head>
<body>
...
<textarea placeholder="Write An Article Description Here..." class="text_content" id="txtEditor" name="ArticleDescription"></textarea>
		...
		<div class="container-fluid">
			...
			</div><script type="text/javascript" src="../assets/js/service-3.1.1.min.js"></script>
		</div>
...
function articleDelete(id,user_id){
	$.ajax({
            ...
            data : {article_id:id,userid:user_id},
            cache: false, 
            async: false,  
