...
<?php
$counter++;
if ($counter < safe_count(is_array($fpath) ? $fpath : [])) { ?>
...
<div class="row attachments">
 <?php if(is_array($files) && safe_count($files) > 0 && $files != 'No Files') { ?>
...
function get_folder_document_icon($file_type){
  ...
  switch($file_type){
	case 'jpg': $icon = base_url() . 'graphics/foldericons/icon-jpg.png'; break;
	case 'png': $icon = base_url() . 'graphics/foldericons/icon-png.png'; break;
    case 'jpeg': $icon = base_url() . 'graphics/foldericons/icon-jpeg.png'; break;
    case 'pdf': $icon = base_url() . 'graphics/foldericons/icon-pdf.jpg'; break;
    case 'doc': $icon = base_url() . 'graphics/foldericons/icon-word.jpg'; break;
    case 'docx': $icon = base_url() . 'graphics/foldericons/icon-word.jpg'; break;
    case 'odt': $icon = base_url() . 'graphics/foldericons/icon-word-odt.png'; break;
    case 'ods': $icon = base_url() . 'graphics/foldericons/icon-ods.jpg'; break;
    case 'odp': $icon = base_url() . 'graphics/foldericons/icon-odp.jpg'; break;
    case 'txt': $icon = base_url() . 'graphics/foldericons/icon-text.png'; break;
    case 'rtf': $icon = base_url() . 'graphics/foldericons/icon-text.png'; break;
    case 'xls': $icon = base_url() . 'graphics/foldericons/icon-xls.png'; break;
    case 'xlsx': $icon = base_url() . 'graphics/foldericons/icon-xls.png'; break;
    case 'xps': $icon = base_url() . 'graphics/foldericons/icon-xps.png'; break;
    case 'zip': $icon = base_url() . 'graphics/foldericons/icon-zip.png'; break;
    case 'rar': $icon = base_url() . 'graphics/foldericons/icon-rar.png'; break;
    case 'mp3': $icon = base_url() . 'graphics/foldericons/icon-mp3.jpg'; break;
    case 'html': $icon = base_url() . 'graphics/foldericons/icon-html.png'; break;
    case 'css': $icon = base_url() . 'graphics/foldericons/icon-html.png'; break;
    case 'htm': $icon = base_url() . 'graphics/foldericons/icon-html.png'; break;
    case 'js': $icon = base_url() . 'graphics/foldericons/icon-js.gif'; break;
    case 'xml': $icon = base_url() . 'graphics/foldericons/icon-xml.png'; break;
    case 'php': $icon = base_url() . 'graphics/foldericons/icon-php.png'; break;
    case 'ppt': $icon = base_url() . 'graphics/foldericons/icon-ppt.png'; break;
    case 'pptm': $icon = base_url() . 'graphics/foldericons/icon-ppt.png'; break;
    case 'pptx': $icon = base_url() . 'graphics/foldericons/icon-ppt.png'; break;
  default: $icon = base_url() . 'graphics/icon_pdf.png'; break;
  }
  return $icon;
}
