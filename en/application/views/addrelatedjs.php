		...
		if($("#uploadFile").val()) {  
			...
			$(this).ajaxSubmit({ 
			   ...
			   success:function (data){
					...
					$("#success").show();
					setTimeout(function(){ displayView("<?=$main_record_type_id;?>","<?=$recordId;?>","<?=$modName;?>","<?=$record_type_id;?>"); },3000);
			   },
			   resetForm: true
			}); 
		    return false; 
