...
<div class="container">
    <section class="maindiv">
        ...
        <b>Ntotalworld may use the Privacy Policy given below:</b>
        <p>The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to <b>iPublish Advanced Technologies Solutions Pvt Ltd.,</b> and the terms "You" /"Your" / "Yourself" refer to the users</p>
        ...
        <p>This Privacy Policy is a legally binding document between you and Ntotalworld (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and Ntotalworld for your use of the website “Website” (defined below).</p>
        ...
        <p>Such information will not be considered as sensitive if it is freely available and accessible in the public domain or is furnished under the Right to Information Act, 2005 or any other law for the time being in force.
        </p>
        ...
        <p>Redressal Mechanism: Any complaints, abuse or concerns with regards to content and or comment or breach of these terms shall be immediately informed to the designated Grievance Officer as mentioned below via in writing or through email signed with the electronic signature to Anusha Jagarlamudi ("Grievance Officer").
        </p>

        <p>Mrs. Anusha Jagarlamudi (Grievance Officer)</p>
        <p>www. Ntotalworld.com</p>
        <p>Company Name & Address: iPublish ATS, H# 8-5/739, Sai Anurag Colony, Bachupally, Hyderabad -500090, /telangana</p>
        <p>Email: anu.maguluri@gmail.com</p>
        <p>Ph: 8328141528</p>
    </section>
</div>

<?php include 'includes/footer_index_view.php'; ?>
<style>
    p,
    li {
        color: #000;
