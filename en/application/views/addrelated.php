...
<div class="row">
   <div class="left-heading col-md-6">
    ...
    <div class="right-heading col-md-6">
           <a class="pull-right" href="#" onclick = "getVal('<?=$main_record_type_id;?>','<?=$modName;?>')"> Back </a>
        </div>
    </div>
...
foreach($fields['data'] as $field){
	...
	if($fieldType == 2 && $fieldId != '560'){ ?>
		<div class="col-md-6 field">
			...
			<input type="text" class="col-sm-8 col-xs-12 <?=$isMandatory;?>" placeholder="Enter <?=$field['FieldLable'];?>" name="<?=$fieldName;?>" id ="<?=$fieldName;?>">
		</div>
    <?php }
    ...
    if($fieldType == 6){ ?>
	        ...
	        <div class='col-sm-6 field'>
				...
				<textarea class="col-sm-8 col-xs-12 <?=$isMandatory;?>" name="<?=$fieldName;?>" placeholder="Enter <?=$field['FieldLable'];?>" id ="<?=$fieldName;?>"></textarea>
			</div>
    <?php }
	if($fieldType == 7){ ?>
		<div class='col-sm-6 field'>
