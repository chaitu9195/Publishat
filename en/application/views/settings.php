...
<table  cellpadding="4" cellspacing="0" class="col-xs-12 col-md-10 col-md-offset-1 ">
       ...
       <div class="row" id="settings_content">
     		        ...
     		        <tr align="center"> <td colspan="2">Show / Hide your Academic Records Settings you do like to update/upload.</td></tr>
        ...
        $.ajax({
            ...
            if(data !='success' )  {       
              ...
              $('#error').show();
                     ...
                     $('#error').show();
                 setTimeout( function() { window.location ="records";  /* getsettings_data(module); $('#error').hide(); */ } , 4000);
            /*   
...
<style>
.h_title{ padding:10px 20px; font-weight:500;    font-size: 15px; }
td, th {
    padding: 3px;
