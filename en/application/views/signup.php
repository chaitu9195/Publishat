...
<style>
  ...
  .signupform input, select, button, label{
     margin:1%;
  }
  .signupform label{
     margin-left:20%
...
$(document).ready(function(){
 $("#signup_btn").click('on',function(){
    if($("#fullname").val() == ""){
      ...
      $("#conf_email").css({"border": "1px solid red"});
      $("#conf_email").focus();
      return false;
    }
     ...
     <hr/>
      ...
      <form action="signup" method="POST">
          ...
          <div class="form-group">
           ...
           <div class="col-md-8 col-xs-12">
              <input type="checkbox" style="float:left" id="terms"> <p> By clicking Sign Up, you agree to our <a href="https://www.publishat.com/terms.php">Terms</a> and <a href="https://www.publishat.com/privacy.php">Privacy</a></p>
          </div>
