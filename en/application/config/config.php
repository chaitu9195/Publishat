...
$RequestURI = $protocal . '://' . $_SERVER['HTTP_HOST'];
// Dynamic base_url based on the accessed domain (works on localhost and any
// deployed host). Scheme reuses the proxy-aware $protocal detected above; the
...
$config['sess_time_to_update'] = 108000;
