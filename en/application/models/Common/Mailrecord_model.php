...
class Mailrecord_model extends CI_Model {
  ...
  $dbtable = $this->mongodb->get(TBL_RECORDTYPE);
   ...
   $sub_id_arr = $params["sub_record_id"];
    ...
    if (count($record_id_arr ?? array()) > 0){
      ...
      foreach($record_id_arr as $l_record_id){  
        ...
        if (empty($selective_attach)){
          ...
          $this->mongodb->where(array("RecordId"=>mongo_id($l_record_id)));
...
*/
                  ...
                  if($RecordTypeId == 42){
                    $headers = array("key1" => "Event Type","key2" => "Event Name","key3" => "Date");
                  }
          ...
          //$this->db->query($qry);
          return array("status"=>"success","data"=>"Mail has been sent.");
//               }
            //events end
      }
      else{
        $status_message = "Error: No emails have been sent. Please try again. ";  
          return array("status"=>"failed","data"=>"No mails sent");
...
function get_school_select($document_id_arr, $record_id, $table_bg, $tr_bg,$document_type,$addtext){
  $record_type_id = 1;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
  ...
  if (count($qry ?? array()) > 0){
    ...
    else if($document_type == "Hall Ticket" || $document_type == "ID Card")
    {
    ...
    if(!empty($document_id_arr) && count($document_id_arr ?? array()) > 0){
...
function get_ug_select($document_id_arr, $record_id, $table_bg, $tr_bg,$document_type,$addtext,$sub_id_arr){
  $record_type_id = 2;
  $email_body = "";  
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_pg_select($document_id_arr, $record_id, $table_bg, $tr_bg,$document_type,$addtext,$sub_id_arr){
  $record_type_id=3;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_phd_select($document_id_arr, $record_id, $table_bg, $tr_bg,$document_type,$addtext){
  $record_type_id = 4;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_certification_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 5;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
  ...
  if (count($qry ?? array()) > 0){      
    ...
    $notes = stripslashes($rec["Notes"]);
    if (!empty($username)) $username_password = $username;
    if (!empty($password)) $username_password .= "/" . $password;
    if(!empty($document_id_arr) && count($document_id_arr ?? array()) > 0){
      $attachments = $this->get_document_email_links_by_id_arr($document_id_arr, $record_type_id, $record_id);
    }
    else{
...
function get_exam_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 6;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_projects_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 7;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_location_select($document_id_arr, $record_id, $table_bg, $tr_bg,$travel_status,$addtext){
  $record_type_id = 8;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
  ...
  if (count($qry ?? array()) > 0){      
    ...
    if (!empty($family_member_2)) $family_members .= ", " . $family_member_2;
    if (!empty($family_member_3)) $family_members .= ", " . $family_member_3;
...
function get_govt_select($document_id_arr, $record_id, $table_bg, $tr_bg,$document_type,$addtext){
  $record_type_id = 9;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
  ...
  if (count($qry ?? array()) > 0){      
      ...
      $email_template = "../../templates/email-personal-govtcert-template.html";
        ...
        else if($document_type == "PAN Card" || $document_type == "Employee State Insurance (ESI)")
    {
...
function get_relation_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 10;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_web_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 11;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_travel_select($document_id_arr, $record_id, $table_bg, $tr_bg,$travel_type,$travellers,$addtext){
  $record_type_id = 12;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
  ...
  if (count($qry ?? array()) > 0){      
    ...
    {     
      $email_template = "../../templates/email-personal-travel-template.html";
        ...
        else if(($travel_type == "International") && ($travellers == "Single" || $travellers = ""))
    {
    $email_template = "../../templates/email-personal-travel-template1.html";  
    }
        else if(($travel_type == "Domestic" || $travel_type == "Others") && ($travellers == "Family" || $travellers == "Group"))
    {
    ...
    $members = $member_1;
    if (!empty($member_2)) $members .= ", " . $member_2;
    if (!empty($member_3)) $members .= ", " . $member_3;
    $members = trim($members, " ,");
    if (empty($members)) $members = "N/A";
...
function get_warranty_select($document_id_arr, $record_id, $table_bg, $tr_bg,$document_type,$addtext){
  $record_type_id = 13;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_events_select($document_id_arr, $record_id, $table_bg, $tr_bg,$event_type,$addtext){
  $record_type_id = 42;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_contacts_select($document_id_arr, $record_id, $table_bg, $tr_bg,$contact_type,$category,$addtext){
  $record_type_id = 14;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
  ...
  if (count($qry ?? array()) > 0){
    ...
    else if(!($contact_type == "Group") && $category == "Personal")
    {
...
function get_pro_contact_related_html($document_id_arr, $user_id, $parent_record_id){
...
function get_employment_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 15;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
  ...
  if (count($qry ?? array()) > 0){      
    ...
    $reference_1 = "";
    if (!empty($ref_name_1)) $reference_1 = $ref_name_1;
    if (!empty($ref_email_1)) $reference_1 .= ", " . $ref_email_1;
    if (!empty($ref_mobile_1)) $reference_1 .= ", " . $ref_mobile_1;
    
    $reference_2 = "";
    if (!empty($ref_name_2)) $reference_2 = $ref_name_2;
    if (!empty($ref_email_2)) $reference_2 .= ", " . $ref_email_2;
    if (!empty($ref_mobile_2)) $reference_2 .= ", " . $ref_mobile_2;
...
function get_proprojects_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext,$sub_id_arr){
  $record_type_id = 16;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_skills_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 17;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_apps_select($document_id_arr, $record_id, $table_bg, $tr_bg,$password_change_status,$addtext){
  $record_type_id = 18;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_resume_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 38;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
  $qry = $this->mongodb->get(TBL_RESUME);
  if (count($rec ?? array()) > 0){      
...
function get_medicaltest_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext, $sub_id_arr){
...
function get_med_test_test_html($document_id_arr, $user_id, $parent_record_id, $sub_id_arr){
  $output_str = "";
  if(count($sub_id_arr ?? array()) > 0){
    for($i=0;$i<count($sub_id_arr ?? array());$i++){ 
      $this->mongodb->where(array("RecordId"=>mongo_id($sub_id_arr[$i]),"UserId"=>mongo_id($user_id)));
  ...
  if (count($qry ?? array()) > 0){       
      ...
      else if(!empty($document_id_arr) && count($document_id_arr ?? array()) > 0){
...
function get_prescription_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext, $sub_id_arr){
    $record_type_id = 20;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_med_prescription_prescription_html($document_id_arr, $user_id, $parent_record_id){
  ...
  if ($res->num_rows() > 0){       
      ...
      else if (count($document_id_arr ?? array()) > 0 && !empty($document_id_arr)){
...
function get_med_prescription_medicine_html($document_id_arr, $user_id, $parent_record_id, $sub_id_arr){
  global $record_type_id, $user_email;
  $html_content = "";
  $output_str = "";
  if(count($sub_id_arr ?? array()) > 0){
...
function get_familyhealth_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext, $sub_id_arr){
...
function get_healthinsurance_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext, $sub_id_arr){
...
function get_legaldispute_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 28;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_ownershiptrnsfr_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 29;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_finaccounts_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 30;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_finassets_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 31;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_finrevenues_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext, $sub_id_arr){
  $record_type_id = 32;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_fin_revenue_related_html($document_id_arr, $user_id, $parent_record_id, $sub_id_arr){
  global $record_type_id, $user_email;
  $html_content = "";
  $output_str = ""; 
  if(count($sub_id_arr ?? array()) > 0){
...
function get_fincards_select($document_id_arr, $record_id, $table_bg, $tr_bg,$card_type,$usage_type,$addtext){
  $record_type_id = 33;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
  ...
  //log_message('info','query success');      
      if(($card_type == "Credit" || $card_type == "Others" || $card_type == "") && ($usage_type == "Joint"))
    {
      $email_template = "../../templates/email-financial-cards-template.html";
        ...
        else if(($card_type == "Credit" || $card_type == "Others" || $card_type == "") && ($usage_type == "Self" || $usage_type == "Others"))
        {
     $email_template = "../../templates/email-financial-cards-template1.html"; 
    } 
     else if(($card_type == "Debit" || $card_type == "Forex") && ($usage_type == "Joint"))
     {
       $email_template = "../../templates/email-financial-cards-template2.html";  
     }
     else if(($card_type == "Debit" || $card_type == "Forex") && ($usage_type == "Self" || $usage_type == "Others"))
     {
       $email_template = "../../templates/email-financial-cards-template3.html";  
     }
     else if(($card_type == "Discount" || $card_type == "Shopping") && ($usage_type == "Joint"))
     {
...
function get_finliability_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 34;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_finpayment_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext,$sub_id_arr){
  $record_type_id = 35;
  $email_body = "";    
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_fin_payment_related_html($document_id_arr, $user_id, $parent_record_id,$sub_id_arr){
  global $record_type_id, $user_email;
  $html_content = "";
  $output_str = ""; 
  if(count($sub_id_arr ?? array()) > 0){
...
function get_fintax_select($document_id_arr, $record_id, $table_bg, $tr_bg,$addtext){
  $record_type_id = 36;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_fininsurance_select($document_id_arr, $record_id, $table_bg, $tr_bg,$insurance_type,$addtext){
  $record_type_id = 37;
  $email_body = ""; 
  $this->mongodb->where(array("RecordId"=>mongo_id($record_id)));
...
function get_document_email_links($record_type_id, $record_id){ 
  ob_start();
  //echo $record_type_id;
  ...
  if ($res->num_rows() > 0){
      ...
      if (empty($doc_tag)) $doc_tag = "$file_tag";  
...
function get_document_email_links_by_id_arr($document_id_arr, $record_type_id, $record_id){ 
  ob_start();
  if (count($document_id_arr ?? array()) > 0){
    //$doc_id_str = implode(",",$document_id_arr); 
    for($i=0;$i<count($document_id_arr ?? array());$i++){
      $this->mongodb->where(array("RecordId"=>mongo_id($record_id),"DocumentId"=>mongo_id($document_id_arr[$i])));
    ...
    if (count($qry ?? array()) > 0){
      foreach($qry as $rec){
        ...
        //$file_tag=strtolower(substr(strstr($filename,"-"),1)); 
        //$file_tag = substr($file_tag,'0','15');     
        if (empty($doc_tag)) $doc_tag = "$filename";  
...
function get_document_icon($file_type){ 
    ...
    switch($file_type){
      ...
      case "ppt": $icon = "graphics/icon_ppt.png"; break;
...
function date_format_short($date){
  if (!empty($date)){ $date = str_replace('/', '-', $date);$date = date("d F Y", strtotime($date));}
  return $date;
}

function get_med_test_test_html1($document_id_arr, $user_id, $parent_record_id,$path){
...
function get_document_email_links1($record_type_id, $record_id,$path){
  ob_start();
...
function get_document_email_links_by_id_arr1($document_id_arr, $record_type_id, $record_id,$path){
  ob_start();
...
function get_project_task_html($document_id_arr, $user_id, $parent_record_id,$sub_id_arr){
  global $record_type_id, $user_email;
  $html_content = "";
  $output_str = "";
  if(count($sub_id_arr ?? array()) > 0){
...
function get_ug_marksmemo_html($document_id_arr, $user_id, $parent_record_id, $sub_id_arr){
  global $record_type_id, $user_email;
  $html_content = "";
  $output_str = "";
  if(count($sub_id_arr ?? array()) > 0){
...
function get_pg_marksmemo_html($document_id_arr, $user_id, $parent_record_id, $sub_id_arr){ 
  global $record_type_id, $user_email;
  $html_content = "";
  $output_str = "";
  if(count($sub_id_arr ?? array()) > 0){
...
function get_med_family_patient_html($document_id_arr, $user_id, $parent_record_id, $sub_id_arr){
  global $record_type_id, $user_email;
  $html_content = "";
  $output_str = ""; 
  if(count($sub_id_arr ?? array()) > 0){
...
function get_med_insurance_beneficiary_html($document_id_arr, $user_id, $parent_record_id, $sub_id_arr){
  $output_str = "";
  if(count($sub_id_arr ?? array()) > 0){
    for($i=0;$i<count($sub_id_arr ?? array());$i++){ 
      $this->mongodb->where(array("RecordId"=>mongo_id($sub_id_arr[$i]),"UserId"=>mongo_id($user_id)));
